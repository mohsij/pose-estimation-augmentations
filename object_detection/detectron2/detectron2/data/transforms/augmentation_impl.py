...
class RandomStars(Augmentation):
    """
    Add random "feathered" white dots to an image half the time this augmentation
    is applied.
    """
    def __init__(self, mean_min=0.05, mean_max=0.15, std_min=0.03, std_max=0.05):
        """
...
class RandomHaze(Augmentation):
    """
    Add random haze effect to the image.
    """
    def __init__(self, mean_min=0.05, mean_max=0.15, std_min=0.03, std_max=0.05):
        """
        Args:
...
class RandomFlares(Augmentation):
    """
    Add random effect that looks like a lens flare from a 5-blade iris.
    Effect is applied half the time.
    """
    def __init__(self):
        """
        Args:
...
class RandomStreaks(Augmentation):
    """
    Add random effect that looks like light leak/streaks.
    Effect is applied half the time.
    """
    def __init__(self, mean_min=0.05, mean_max=0.15, std_min=0.03, std_max=0.05):
        """
    ...
    def _radial_fade(self, image, W=1920, H=1200):
        ...
        # Push that radial gradient transparency onto image.
...
class RandomBloom(Augmentation):
    """
    Add light blooming to the image.
    """
    def __init__(self):
        """
        Args:
...
class RandomErasing(Augmentation):
    """
    Erase random portion of the image.
    """
    def __init__(self):
        """
        Args:
